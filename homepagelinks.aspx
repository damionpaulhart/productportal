...
<body>
    ...
    <div>
        <div>
            ASP
            <ul>
            <li><a href="fcsfiles/asp/DLRMSTRupdate.xls">NEW ASP SPREADSHEET</a></li>
            <li><a href="http://www.fujitsu.ca/support/notebooks/asp.html">ASP - CANADA</a></li>
            <li>fcsfiles/asp/FujitsuServiceProviders.swf</li>
            </ul>
        </div>
        <div>
            Memphis docs
        ...
        <div id="PartsInfo">
            ...
            <ul>
                ...
                <li><a href="App_Data-Documents/BIOS List v3.01.xls">
                    BIOS List v3.01<span>2009/02/19</span></a></li>
        ...
        <div id="Fax">
            ...
            <ul>
                ...
                <li><strong>Customer Relations Fax</strong>                    408-764-2723</li>
                <li><strong>Escalation Support Fax</strong>                    408-764-2724</li>
                <li><strong>Warranty Fax</strong>                    408-764-2726</li>
            </ul>
        </div>
        <div id="zip">
            <ul>
        ...
        <div id="websites">
            ...
            <ul>
                ...
                <li><a href="https://trioleservicedesk.fai.fujitsu.com/CAisd/pdmweb.exe">Request IT
                    HELP (TRIOLE for Service (TfS)) </a></li>
