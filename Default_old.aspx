...
<head id="Head1" runat="server">
    ...
    <link rel="shortcut icon" href="http://sv-corpfsapps01.fjcs.net/SANDS/favicon.ico"
        type="image/x-icon" />
    ...
    <table>
        <tr>
            <td id="master_header" colspan="2">
                ...
                <span style="float: right;">Fujitsu America
                    <asp:Label ID="Label1" runat="server" Text="(# users)"></asp:Label></span>
            </td>
        </tr>
        <tr>
            <td id="master_nav" colspan="2">
                <a href="default.aspx">Home</a><a href="http:\\sv-corpfsapps01.fjcs.net\SANDS\fcsfiles\lut">Look
                    Up Tables</a> <a href="http:\\sv-corpfsapps01.fjcs.net\SANDS\fcsfiles\drawings" target="_blank">
                        Exploded Diagrams</a>
            </td>
        </tr>
        <%--<tr>
...
<asp:Button ID="ButtonQuickConfig" runat="server" Text=">>" OnClick="ButtonQuickConfig_Click" Width="30px" /><br />
                ...
                <div class="bannerbar">
                    <a href="http://support.fujitsupc.com/CS/Portal/supporthome.do" style="color:#ffffff; font-size:.6em;" target="_blank">Mobile Support Homepage</a>
                </div>
                <div class="serieslinks">
                    <table width="100%">
                        <tr>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <div class="filter">
                                                            ...
                                                            <asp:Button ID="Button1" runat="server" CssClass="button" Text="Search Models" /><br />
                                                        </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="width: 200px; border: solid 1px #cccccc; padding: 12px; margin: 12px;">
                                                            ...
                                                            <a href="fcsfiles/asp/Master ASP List.xls">Master ASP List</a></div>
                                                    </td>
                                                    <td>
        ...
        <tr>
            <td id="master_footer" colspan="2">
                <span>All Rights Reserved, Copyright &#169; Fujitsu America Incorporated 2001-2009</span>
            </td>
        </tr>
    </table>
    </form>
